...
- 宠物声音跟随已经显示在屏幕上的表演：进食、被抚摸、玩耍、说话、伸懒腰、入睡和醒来分别使用独立音型。说话音型会继续结合饥饿、疲劳、低落、亲密度和成长后的性格路线变化；普通眨眼、抖耳和转头保持安静。
...
37. 提前唤醒，确认主页显示后播放上行醒来音型；在主页等待自主动作，伸懒腰、饥饿或疲劳动作可以发出轻声，普通眨眼、抖耳和转头保持安静。
